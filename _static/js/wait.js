...
$(document).ready(function () {
    ...
    if(platform != undefined && platform != ""){
        ...
        if(workerId != undefined && workerId != ""){
            ...
            $("#worker-id-feedback").html("Please submit your " + platformDisplay + " worker-id to continue. Your Worker ID starts with the letter A and has 12-14 letters of numbers. It is not your email address. If we do not have your correct Worker ID we cannot pay you.");
    ...
    var makeMatch = function(questionnaireAnswers) {
        ...
        $("#loader").show();
        $('#message-panel').append('<p>Looking for a partner... Could take up to 1 minute</p>');
